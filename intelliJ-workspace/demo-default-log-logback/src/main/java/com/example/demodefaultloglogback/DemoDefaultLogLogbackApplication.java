package com.example.demodefaultloglogback;
...
public class DemoDefaultLogLogbackApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(DemoDefaultLogLogbackApplication.class, args);
    }
    ...
    public void run(String... args) throws Exception {
        ...
        loggerA.log(Level.FINE, "FINE Message from serviceA");
        ...
        loggerF.log(Level.ALL, "ALL Log Level Message from serviceF");
    }
}
