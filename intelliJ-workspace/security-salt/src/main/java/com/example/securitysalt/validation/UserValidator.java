package com.example.securitysalt.validation;

import com.example.securitysalt.ds.RegisteringUser;
...
public class UserValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (!registeringUser.getPassword().equals(registeringUser.getRepeatedPassword())) {
            errors.rejectValue("password", null, "Password and repeated password needs to mathch.");
        }
    }
