...
public class Customer {
    ...
    @NotBlank(message = "{customer.name.validator.notblank}")
    @Size(min = 2,max=5,message = "{customer.name.validator.msg}")
    @Pattern(regexp = "[A-Za-z]*",message = "{customer.name.validator.msg}")
    private String code;
